# RailsAdmin config file. Generated on September 08, 2013 22:52
...
RailsAdmin.config do |config|
  ...
  config.main_app_name = ['Feedman', 'Admin']
  ...
  # config.excluded_models = ['AdminUser', 'Category', 'Entry', 'Feed']

  # Include specific models (exclude the others):
  # config.included_models = ['AdminUser', 'Category', 'Entry', 'Feed']
